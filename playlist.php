					...
					<div class = "Output">
						...
						<div class = "col-md-5" style="border: 1px black solid;position: relative;height: 100%;overflow: auto;">
							...
							<?php
								...
								$weather='rainy';
								$query="select `song_name` from `list_of_songs` where `weather`='$weather' and `mood`='$mood' order by RAND()";
								$query_run = mysqli_query($mycon,$query);
								while($rows=mysqli_fetch_assoc($query_run)){
									?>
									<form action="playlist.php" method="POST">
										<input type="submit" class="s_btn" name="song_n" value="<?php echo $rows['song_name']?>" style="outline: none;border: none;width: 100%;height: 8%;" >
									</form>
									<hr>
									<?php
								}
